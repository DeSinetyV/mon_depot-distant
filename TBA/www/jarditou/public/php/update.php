...
?>
    ...
    <form class="col-6 ml-auto mr-auto" action="script_modif.php" method="POST">
        ...
        <input class="w-100" type="text" name="categorie" placeholder="" value="<?=$result->cat_nom?>" id="categorie"><br><br>
        ...
        <input class="w-100" type="text" name="modification" placeholder="<?=date('Y-m-d')?>" value="<?=$result->pro_d_modif?>" id="modification" readonly><br><br>
