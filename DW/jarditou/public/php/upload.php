...
if (in_array($mimetype, $aMimeTypes))
{
    ...
    var_dump($extension);  
    echo("../images/".$_POST["id"].".".$extension[1]);
    unlink("../images/".$_POST["id"].".jpg");
    unlink("../images/".$_POST["id"].".jpeg");
    unlink("../images/".$_POST["id"].".png");
    unlink("../images/".$_POST["id"].".tiff");
    move_uploaded_file($_FILES["fichier"]["tmp_name"], "../images/".$_POST["id"].".".$extension[1]);        
